...
| onMount                     | Triggered when the hook is called the first time. Usage: trigger initial actions                                                                            | `(actions: Actions, props: Props, s: State) => void;`                            |           |               |  |
...
```json
{
  ...
  "Create context": {
    ...
    "body": [
      ...
      "type Actions = $1Actions;",
      "",
      "export type $1Props = Props & Actions & State & Pick<LoadingProps<Actions>, 'loadingMap'>;",
      "",
      ...
      "export const actions$1: StateDecoratorActions<State, Actions, Props> = {};",
      "",
      "export const $1 = React.createContext<$1Props>(null);",
      "",
      "export function onMount(actions: Actions, p: Props) {}",
      "",
      "export default React.memo(function $1Provider(p: $1PropsIn) {",
      "   const { state: s, actions: a, loadingMap } = useStateDecorator(getInitialState, actions$1, p, {",
      "   onMount,",
      "  });",
      "  return (",
      "    <$1.Provider",
